...
import { GiHamburgerMenu, GiFamilyHouse, GiWoodCabin, GiFarmTractor } from "react-icons/gi";
...
<div className="ham1">SignUp</div>
     ...
     <div className="nav1">
        <Link to={""}><div className="logo">
            <img src="/image.png" alt="logo" width="50px"/>
            <h1>ReeTun Stays</h1>
        </div></Link>
  ...
  <div className="svg11"><GiFarmTractor /> <h3>Farm Houses</h3></div>
  ...
  <div className="svg11"><FaTree /> <h3>Forest Houses</h3></div>
</div>
     </div>
  )
}
